...
scatter(ones(1,length(T_k4)),1./T_k4,'MarkerFaceColor',colors(2,:),'MarkerEdgeColor',[0 0 0])
scatter(2*ones(1,length(T_k8)),1./T_k8,'MarkerFaceColor',colors(3,:),'MarkerEdgeColor',[0 0 0])
scatter(3*ones(1,length(T_k16)),1./T_k16,'MarkerFaceColor',colors(4,:),'MarkerEdgeColor',[0 0 0])

scatter(0,1/Tn_k2,100,'p','MarkerFaceColor',colors(1,:),'MarkerEdgeColor',[0 0 0])
scatter(1,1/Tn_k4,100,'p','MarkerFaceColor',colors(2,:),'MarkerEdgeColor',[0 0 0])
scatter(2,1/Tn_k8,100,'p','MarkerFaceColor',colors(3,:),'MarkerEdgeColor',[0 0 0])
scatter(3,1/Tn_k16,100,'p','MarkerFaceColor',colors(4,:),'MarkerEdgeColor',[0 0 0])
...
print(fig,['C:\Users\hais0030\Documents\MATLAB\MinorVariationsAdaptation\CodeSubmission_reviews_1\evosim_nomix_contrasting_randn\fitness_increase\plot_evosim_fitness_'+surv+'_all'],'-depsc','-r300')
